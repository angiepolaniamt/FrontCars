...
function autoInicioMensajes(){
    ...
    $.ajax({
        url:"http://129.151.112.106:8080/api/Message/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
...
function pintarRespuestaMensajes(respuesta){
    ...
    let myTable="<table>";
    myTable+="<tr><th>Mensaje</th><th>Carro</th><th>Cliente</th></tr>";
...
function guardarInformacionMensajes(){
    ...
    let var2 = {
        ...
        url:"http://129.151.112.106:8080/api/Message/save",
...
function actualizarInformacionMensaje(idElemento){
    ...
    $.ajax({
        url:"http://129.151.112.106:8080/api/Message/update",
        type:"PUT",
        data:dataToSend,
...
function borrarMensaje(idElemento){
    ...
    $.ajax({
        url:"http://129.151.112.106:8080/api/Message/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
